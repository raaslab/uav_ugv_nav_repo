""" Takeoff and Hover at defined Altitude for UAV (m500 drone) using GPS.
"""
...
def main():
	...
	# # Take off command inside F3 cage (Designated Location)
	# takeoff_call(38.973593863069446, -76.92190286766103, 1)

	# Hover
	rospy.sleep(10)

	# Land at current positon
	land_call(latitude, longitude, 0)

	# # Land inside F3 cage (Designated Location)
