...
def main():
	...
	# takeoff_call(latitude, longitude, 1)
	...
	waypoints = [
		...
		Waypoint(frame = 3, command = 16, is_current = 0, autocontinue = True, param1 = 5, x_lat = 38.973584479463675, y_long = -76.92188878606414, z_alt = 1),
		Waypoint(frame = 3, command = 16, is_current = 0, autocontinue = True, param1 = 5, x_lat = 38.97361158765467, y_long = -76.9219618762575, z_alt = 1),
		Waypoint(frame = 3, command = 16, is_current = 0, autocontinue = True, param1 = 5, x_lat = 38.97364025976846, y_long = -76.92189683269095, z_alt = 1),
		Waypoint(frame = 3, command = 16, is_current = 0, autocontinue = True, param1 = 5, x_lat = 38.973593863069446, y_long = -76.92183111857216, z_alt = 1),
		Waypoint(frame = 3, command = 16, is_current = 1, autocontinue = True, param1 = 5, x_lat = 38.973606374541816, y_long = -76.92188945661638, z_alt = 1)
	]
	...
	# TEST4
	waiting_ugv(38.973575617168244, -76.92188945661638, 1) # Checks if ugv is at lat long
