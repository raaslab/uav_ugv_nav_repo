...
def main():
	...
	waypoints = [
		...
		Waypoint(frame = 3, command = 16, is_current = 1, autocontinue = True, param1 = 5, x_lat = 47.3977419, y_long = 8.5455952, z_alt = 5),
		Waypoint(frame = 3, command = 16, is_current = 1, autocontinue = True, param1 = 5, x_lat = 47.3977419, y_long = 8.5456038, z_alt = 5),
		Waypoint(frame = 3, command = 16, is_current = 1, autocontinue = True, param1 = 5, x_lat = 47.3977419, y_long = 8.5456052, z_alt = 5)
	]
	...
	# TEST4
	waiting_ugv(47.3977419, 8.5458982, 5) # Checks if ugv is at lat long
